...
<Callout type="info">
  ...
  <Link href="/concepts/action-routing">here</Link>
</Callout>

If you're looking for compatibility and installation guide then head over to <Link href="/installation">here</Link>
