...
> 📝 **NOTE**:
> For example project structure reference, click **<a style={{ textDecoration: 'underline', color: 'lightblue' }} href="/concepts#file-conventions">here</a>**
...
(aka <a style={{ textDecoration: "underline", color: 'lightblue' }} href="https://stackoverflow.com/questions/52453407/the-difference-between-object-and-plain-object-in-javascript" target="\_blank">POJO</a>).
...
For mental model, you can think of it as a <a style={{ color:"lightblue", textDecoration: "underline" }} href="/concepts#how-action-routing-works" target="\_blank">tree starting
from root and then branching off in different directions as needed.</a>
